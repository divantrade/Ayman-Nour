          ...
          <FadeIn direction="left" delay={0.2}>
            {submitted ? (
              <div className="text-center py-16">
                ...
                <button onClick={() => setSubmitted(false)} className="mt-6 text-orange font-semibold hover:underline bg-transparent border-none cursor-pointer text-base">
                  إرسال رسالة أخرى
                </button>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <input
                  ...
                  className="w-full px-[18px] py-3.5 bg-white/[0.08] border border-white/[0.15] rounded-lg text-white text-sm outline-none transition-colors focus:border-orange placeholder:text-white/30 font-[inherit]"
                />
                <input
                  type="email" required placeholder="البريد الإلكتروني" dir="ltr" style={{ textAlign: "right" }}
                  className="w-full px-[18px] py-3.5 bg-white/[0.08] border border-white/[0.15] rounded-lg text-white text-sm outline-none transition-colors focus:border-orange placeholder:text-white/30 font-[inherit]"
                />
                <input
                  type="text" required placeholder="الموضوع"
                  className="w-full px-[18px] py-3.5 bg-white/[0.08] border border-white/[0.15] rounded-lg text-white text-sm outline-none transition-colors focus:border-orange placeholder:text-white/30 font-[inherit]"
                />
                <textarea
                  required placeholder="الرسالة..." rows={5}
                  className="w-full px-[18px] py-3.5 bg-white/[0.08] border border-white/[0.15] rounded-lg text-white text-sm outline-none transition-colors focus:border-orange placeholder:text-white/30 resize-y font-[inherit]"
                />
                <button
                  type="submit"
                  className="w-full bg-gradient-to-br from-orange to-orange-dark text-white border-none px-8 py-3.5 rounded-full text-[15px] font-semibold cursor-pointer transition-all hover:-translate-y-0.5 hover:shadow-[0_4px_20px_rgba(232,116,42,0.4)]"
                >
